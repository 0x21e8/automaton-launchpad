...
1. `/Users/domwoe/Dev/projects/automaton-launchpad/ralph/reports/checklists/S01-make-startup-fail-clearly-when-the-canister-list.md`
...
- ITEM_ID: `S01-make-startup-fail-clearly-when-the-canister-list`
...
- TITLE: Make startup fail clearly when the canister list or network target is invalid.
- GOAL: Make startup fail clearly when the canister list or network target is invalid.
...
- Write the checklist item report to `/Users/domwoe/Dev/projects/automaton-launchpad/ralph/reports/checklists/S01-make-startup-fail-clearly-when-the-canister-list.md`.
- Append a new dated section to `ralph/notes/rolling-handoff.md` for `S01-make-startup-fail-clearly-when-the-canister-list`.

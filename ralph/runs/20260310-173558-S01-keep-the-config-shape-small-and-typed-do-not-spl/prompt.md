...
1. `/Users/domwoe/Dev/projects/automaton-launchpad/ralph/reports/checklists/S01-keep-the-config-shape-small-and-typed-do-not-spl.md`
...
- ITEM_ID: `S01-keep-the-config-shape-small-and-typed-do-not-spl`
...
- TITLE: Keep the config shape small and typed; do not split core runtime targeting across multiple unrelated env vars.
- GOAL: Keep the config shape small and typed; do not split core runtime targeting across multiple unrelated env vars.
...
- Write the checklist item report to `/Users/domwoe/Dev/projects/automaton-launchpad/ralph/reports/checklists/S01-keep-the-config-shape-small-and-typed-do-not-spl.md`.
- Append a new dated section to `ralph/notes/rolling-handoff.md` for `S01-keep-the-config-shape-small-and-typed-do-not-spl`.

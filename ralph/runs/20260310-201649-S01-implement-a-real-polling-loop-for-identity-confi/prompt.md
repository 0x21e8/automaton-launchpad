...
1. `/Users/domwoe/Dev/projects/automaton-launchpad/ralph/reports/checklists/S01-implement-a-real-polling-loop-for-identity-confi.md`
2. `ralph/notes/rolling-handoff.md`

## Required report format

```md
# S01-implement-a-real-polling-loop-for-identity-confi Implement a real polling loop for identity/config reads for the target automaton.
...
- ITEM_ID: `S01-implement-a-real-polling-loop-for-identity-confi`
...
- TITLE: Implement a real polling loop for identity/config reads for the target automaton.
- GOAL: Implement a real polling loop for identity/config reads for the target automaton.
...
- Write the checklist item report to `/Users/domwoe/Dev/projects/automaton-launchpad/ralph/reports/checklists/S01-implement-a-real-polling-loop-for-identity-confi.md`.
- Append a new dated section to `ralph/notes/rolling-handoff.md` for `S01-implement-a-real-polling-loop-for-identity-confi`.
